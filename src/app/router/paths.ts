export const adminRoutes = {
  ...
  testsTestAdd: '/admin/tests/test/add',
  testsTestIdEdit: '/admin/tests/test/:testId/edit',
  testsTaskAdd: '/admin/tests/task/add',
  testsTaskIdEdit: '/admin/tests/task/:taskId/edit',
